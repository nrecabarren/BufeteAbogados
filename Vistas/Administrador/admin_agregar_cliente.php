...
<section class="main_content col-md-offset-1 col-md-10">
    ...
    <form action="Clientes.php?action=adminAgregarCliente" id="AgregarClienteForm" method="POST" class="col-md-offset-3 col-md-6">
        ...
        <fieldset class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" name="Cliente[telefono]" class="form-control">
            </div>
        </fieldset>
        <fieldset class="form-group row">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.btn-success').on('click',function(e){
            e.preventDefault();
            var error = 0;
            $('#AgregarClienteForm').find('input,select').each(function(){
                if( $(this).val() == "" ){
